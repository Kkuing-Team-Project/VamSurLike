...
public class HUD : MonoBehaviour
{
	...
	private void UIUpdate()
	{
		...
		else
		{
			...
			timeText.text = string.Format("<size= 25>균열 생성까지</size> [ {0:00}:{1:00} ]", (int)spirit.collapseZoneSpawner.remainingTime / 60, (int)spirit.collapseZoneSpawner.remainingTime % 60);
